  ...
  return (
    <main className="legal-page">
      ...
      <article className="legal-copy shell">
        ...
        <h2>Your choices</h2>
        <p>You can clear your browser storage to reset the anonymous device identifier. By using AIRant, you acknowledge that submitted text is processed to generate the requested verdict.</p>
